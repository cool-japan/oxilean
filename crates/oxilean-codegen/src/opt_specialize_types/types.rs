...
pub struct OSTPassRegistry {
    pub(super) configs: Vec<OSTPassConfig>,
    pub(super) stats: std::collections::HashMap<String, OSTPassStats>,
}
...
pub struct SpecTX2PassRegistry {
    pub(super) configs: Vec<SpecTX2PassConfig>,
    pub(super) stats: Vec<SpecTX2PassStats>,
}
...
pub struct OSTAnalysisCache {
    pub(super) entries: std::collections::HashMap<String, OSTCacheEntry>,
...
pub struct SpecTExtPassRegistry {
    pub(super) configs: Vec<SpecTExtPassConfig>,
    pub(super) stats: Vec<SpecTExtPassStats>,
}
