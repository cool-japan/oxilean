...
pub struct RuleSet {
    ...
    pub(super) by_tag: HashMap<String, Vec<usize>>,
}
impl RuleSet {
...
pub struct ApplyRulesTactic {
    pub(super) config: ApplyRulesConfig,
...
struct SubgoalState {
    ...
    pub(super) hypotheses: Vec<String>,
    /// Current depth.
    pub(super) depth: usize,
    /// Accumulated trace.
    pub(super) trace: Vec<RuleApplication>,
}
impl SubgoalState {
...
pub struct ApplyRulesExtConfig3400 {
    pub(super) values: std::collections::HashMap<String, ApplyRulesExtConfigVal3400>,
